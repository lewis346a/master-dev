...
import com.beidou.ui.act.HYDAct;
import com.beidou.ui.act.LunTanAct;
...
public class AdvisoryFragment extends BaseFragment {
    ...
    private void initHeadView(View headView) {
        ...
        tools.add(new ToolBean(R.mipmap.zix,"资讯"));
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                switch (position){
                       ...
                       case 0:
                        ...
                        break;
                        case 1:
                            jumpToActivity(LunTanAct.class);
                        break;
                        case 2:
